...
static NSString const *kARDIceServerURLKey = @"ice_server_url";
...
@synthesize iceServerURL = _iceServerURL;
...
+ (ARDJoinResponse *)responseFromJSONData:(NSData *)data {
  ...
  NSString *iceServerURLString = params[kARDIceServerURLKey];
  response.iceServerURL = [NSURL URLWithString:iceServerURLString];
