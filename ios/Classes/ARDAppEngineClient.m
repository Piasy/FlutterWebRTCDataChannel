...
static NSString * const kARDRoomServerJoinFormat = @"%@/join/%@";
static NSString * const kARDRoomServerMessageFormat = @"%@/message/%@/%@";
static NSString * const kARDRoomServerLeaveFormat = @"%@/leave/%@/%@";
...
- (void)joinRoomWithRoomUrl:(NSString*)roomUrl
    ...
    NSString* urlString =
        [NSString stringWithFormat:kARDRoomServerJoinFormat, roomUrl, roomId];
...
- (void)sendMessage:(ARDSignalingMessage*)message
  ...
  NSString* urlString = [NSString
      stringWithFormat:kARDRoomServerMessageFormat, roomUrl, roomId, clientId];
...
- (void)leaveRoomWithRoomUrl:(NSString*)roomUrl
  ...
  NSString* urlString = [NSString
      stringWithFormat:kARDRoomServerLeaveFormat, roomUrl, roomId, clientId];
  NSURL *url = [NSURL URLWithString:urlString];
  NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url];
  request.HTTPMethod = @"POST";
